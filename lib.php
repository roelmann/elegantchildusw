...
function theme_elegantchildusw_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    if ($context->contextlevel == CONTEXT_SYSTEM) {
        $theme = theme_config::load('elegantchildusw');
        if ($filearea === 'logo') {
...
function theme_elegantchildusw_page_init(moodle_page $page) {
